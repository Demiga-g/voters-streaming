...
def fetch_voting_stats():
    conn = psycopg2.connect("""
        host=localhost dbname=voting user=postgres
...
def update_data():
    ...
    # Fetch data from kafka on aggregated turnout per location
    location_consumer = create_kafka_consumer('aggregated_turnout_per_location')
